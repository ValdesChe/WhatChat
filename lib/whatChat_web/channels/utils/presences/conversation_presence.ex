defmodule WhatChatWeb.ConversationPresence do
  @moduledoc """
  ...
  Presences can be tracked in your channel after joining:
      ...
      defmodule WhatChat.MyChannel do
        use WhatChatWeb, :channel
  ...
  """
  use Phoenix.Presence, otp_app: :whatChat,
                        pubsub_server: WhatChat.PubSub
end
